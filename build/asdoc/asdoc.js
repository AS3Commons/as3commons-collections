...
function toggleExample(link, id) {
	
	var display = document.getElementById(id).style.display == "block" ? "none" : "block";
	
	document.getElementById(id).style.display = display;
	link.className = display == "block" ? "exampleExpanded" : "exampleCollapsed";
	link.innerHTML = display == "block" ? "Hide example" : "Show example";
}